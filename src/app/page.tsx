        ...
        <div className="relative z-10 mx-auto max-w-6xl px-4 sm:px-6">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <div className="mt-8 flex flex-col items-center justify-center gap-3 sm:flex-row">
              <Link href="/story" className="inline-flex items-center rounded-full bg-accent px-6 py-3 text-base font-semibold text-white transition-colors hover:bg-accent-hover">
                Read the Full Story &rarr;
              </Link>
              <Link href="/benchmarks" className="inline-flex items-center rounded-full border border-card-border px-6 py-3 text-base font-semibold text-foreground transition-colors hover:bg-card">
                Are the Benchmarks Real?
              </Link>
              <a href="https://github.com/milla-jovovich/mempalace" target="_blank" rel="noopener noreferrer" className="inline-flex items-center gap-2 rounded-full border border-card-border px-6 py-3 text-base font-semibold text-foreground transition-colors hover:bg-card">
